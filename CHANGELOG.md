...
- The read-only status link is now also emailed to the address the original appeal notice was sent to, so an appellant who closes the page still holds a way back to the appeal they filed.
